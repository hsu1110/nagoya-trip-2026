...
const itineraryData = [
  ...
  },
  {
    ...
    details: [
      ...
      { time: "17:30", icon: "👅", title: "晚餐：和牛たんじ", dbId: 21, desc: "<strong>厚切仙台牛舌與和牛大腹肉壽司吃到飽！</strong>限時 100 分鐘的終極和牛饗宴。" },
      { time: "19:30", icon: "🗼", title: "綠洲 21 ＆ 電視塔夜景", dbId: 20, desc: "吃飽後在榮商圈散步消化，欣賞浪漫的水之宇宙船點燈，隨後搭地鐵回飯店。" }
    ]
  },
  {
    day: 3,
  ...
  },
  {
    ...
    focus: "艾許奶油、小雞蛋糕、蝦仙貝之里",
    logistics: "搭乘名鐵 μ-SKY 特急前往中部國際機場（約 28 分鐘）。",
    meals: "早餐：高島屋點心 / 外帶美食<br>午餐：機場內或機上",
    warnings: "蝦仙貝體積大但輕，強烈建議最後在機場買，直接當手提行李上機，不佔行李箱空間！",
    details: [
      { time: "08:30", icon: "🧈", title: "早餐：ÉCHIRÉ 艾許奶油", dbId: 11, desc: "前往高島屋買 ÉCHIRÉ 艾許奶油點心當早餐。" },
      { time: "08:45", icon: "🐥", title: "外帶：小雞蛋糕 Piyorin", dbId: 16, desc: "去挑戰外帶超萌的小雞蛋糕帶上車享用。" },
